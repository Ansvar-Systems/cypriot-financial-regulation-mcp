...
const TOOLS = [
  {
    ...
    description:
      "Full-text search across CySEC and CBC regulatory provisions — directives, circulars, and prudential directives.",
    inputSchema: {
      type: "object" as const,
      properties: {
        query: { type: "string", description: "Search query (e.g., 'AIF managers', 'client money', 'capital adequacy')" },
        sourcebook: { type: "string", description: "Filter by sourcebook ID (e.g., CYSEC_DIRECTIVES, CBC_DIRECTIVES). Optional." },
        status: {
          type: "string",
  ...
  },
  {
    ...
    description:
      "Get a specific CySEC or CBC provision by sourcebook and reference (e.g., CYSEC_DIRECTIVES / 'DI87-01').",
    inputSchema: {
      type: "object" as const,
      properties: {
        sourcebook: { type: "string", description: "Sourcebook identifier (e.g., CYSEC_DIRECTIVES, CYSEC_CIRCULARS, CBC_DIRECTIVES)" },
        reference: { type: "string", description: "Provision reference (e.g., 'DI87-01', 'C116', 'CBC/2014/1')" },
      },
  ...
  },
  {
    ...
    description: "List all CySEC and CBC sourcebook collections with names and descriptions.",
    inputSchema: { type: "object" as const, properties: {}, required: [] },
  },
  {
    name: "cy_fin_search_enforcement",
    description:
      "Search CySEC enforcement actions — fines, suspensions, licence revocations, and public reprimands.",
    inputSchema: {
      type: "object" as const,
      properties: {
  ...
  },
  {
    ...
    description: "Check whether a specific CySEC or CBC provision reference is currently in force.",
    inputSchema: {
      type: "object" as const,
      properties: {
        reference: { type: "string", description: "Provision reference to check (e.g., 'DI87-01', 'C116')" },
      },
      required: ["reference"],
    },
  },
